...
struct bat_maintian_table {
	int bat_months;
	int bat_max_cv;
	int full_chg_soc;
};

struct bat_maintian_mode {
	int table_size;
	int soc_force_set_full;
	struct bat_maintian_table *bat_maintian_array;
};
...
struct charger_desc {
	...
	struct bat_maintian_mode *bat_maintain;
